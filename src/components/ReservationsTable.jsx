        ...
        <div className="reservations-table">
            <div className="center-content">
                ...
                <div className="location">
                    ...
                    <p>{getTranslation(localStorage.getItem('language'), 'location')}</p>
                </div>

                <div className="status">
                    <img src={StatusIcon} alt="" />
                    <p>{getTranslation(localStorage.getItem('language'), 'status')}</p>
                </div>
                                    ...
                                    <p className='res-status-pending'>
                                        {
                                            x.Status === 'Pending' && (
                                                <>
                                                    ...
                                                    {getTranslation(localStorage.getItem('language'), 'pending')}
                                                </>
                                            )
                                        }
