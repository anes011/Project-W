    ...
    return(
        <div className="more-user-info">
            <div className="add-photo">
                <p>{getTranslation(localStorage.getItem('language'), 'add-profilePhoto')}</p>
            ...
            <div className="location-phone-container">
                <div className="location-container">
                    ...
                    <input ref={locationInput} type="text" placeholder={getTranslation(localStorage.getItem('language'), 'where do you live?')} />
                </div>
                ...
                <div className="phone-number-container">
                    ...
                    <input ref={phoneNumberInput} type="text" placeholder={getTranslation(localStorage.getItem('language'), 'enter your phone number')} />
                </div>
                ...
                <button onClick={createUser}>
                    {
                        registerLoading ? (
                            ...
                            <p>{getTranslation(localStorage.getItem('language'), 'register')}</p>
                        )
                    }
                </button>

                <p>{getTranslation(localStorage.getItem('language'), 'more-user-info note')}</p>
            </div>
        </div>
    )
}
