        ...
        <div className="reservation-details">
            ...
            <div className="accommodation-type-rate">
                {
                    offer !== null && (
                        <div className="type-container">
                            {
                                JSON.parse(offer).placeType === getTranslation(localStorage.getItem('language'), 'house') ? (
                            ...
                            <p>{JSON.parse(offer).placeType.toUpperCase()}</p>
                        </div>
                    )
                }
            ...
            <div className="place-type">
                ...
                <div>
                    ...
                    {
                        offer !== null && (
                            <p>{JSON.parse(offer).spaceGiven}</p>
                        )
                    }
                </div>
            </div>
